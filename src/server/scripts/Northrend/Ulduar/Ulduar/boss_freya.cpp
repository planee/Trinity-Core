...
enum FreyaYells
{
    ...
    // Elder Brightleaf
    SAY_BRIGHTLEAF_AGGRO                         = 10,
    SAY_BRIGHTLEAF_SLAY_1                        = 11,
    SAY_BRIGHTLEAF_SLAY_2                        = 12,
    SAY_BRIGHTLEAF_DEATH                         = 13,

    // Elder Ironbranch
    SAY_IRONBRANCH_AGGRO                         = 14,
    SAY_IRONBRANCH_SLAY_1                        = 15,
    SAY_IRONBRANCH_SLAY_2                        = 16,
    SAY_IRONBRANCH_DEATH                         = 17,

    // Elder Stonebark
    SAY_STONEBARK_AGGRO                          = 18,
    SAY_STONEBARK_SLAY_1                         = 19,
    SAY_STONEBARK_SLAY_2                         = 20,
    SAY_STONEBARK_DEATH                          = 21
};
