...
(190010, 19646, 0, "Warpweaver", "Transmogrifier", NULL, 0, 80, 80, 2, 35, 35, 1, 1, 0, 500, 500, 0, 350, 1, 2000, 0, 1, 0, 0, 0, 0, 7, 0, 0, 0, 0, '', 0, 3, 1, 1, 1, 1, 0, 0, 1, 0, 0, 'Creature_Transmogrify', 0);
...
DELETE FROM `trinity_string` WHERE (`entry`='11101');
DELETE FROM `trinity_string` WHERE (`entry`='11102');
DELETE FROM `trinity_string` WHERE (`entry`='11103');
DELETE FROM `trinity_string` WHERE (`entry`='11104');
DELETE FROM `trinity_string` WHERE (`entry`='11105');
DELETE FROM `trinity_string` WHERE (`entry`='11106');
DELETE FROM `trinity_string` WHERE (`entry`='11107');
DELETE FROM `trinity_string` WHERE (`entry`='11108');
DELETE FROM `trinity_string` WHERE (`entry`='11109');
